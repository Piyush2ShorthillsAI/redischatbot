...
"""
                    ...
                    if function_to_call:
                        try:
                            ...
                            if function_name == "vector_search_hash":
                                ...
                                function_response = await generate_response(query)
                                ...
                                raw_data = await function_to_call(key)
                                print("1")
                                decoded_data = {}
    ...
    # Handle "vector" as raw bytes
                                 if key_str == "vector":
                                          decoded_data[key_str] = v
                                          continue
    ...
    # Decode value safely
                                 try:
                                           ...
                                           decoded_data[key_str] = repr(v)  # fallback to printable string
